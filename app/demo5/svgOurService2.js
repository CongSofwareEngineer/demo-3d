...
const SvgOurService2 = () => {
  ...
  return (
    ...
    >
      ...
      <RectCustom onMouseDown={() => handleClick(TYPE.ourService)} id='rectOurService' x="390" y="960" width="2560" height="1097" fill="url(#pattern2)" />
      ...
      <defs>
        ...
        <image
          id={!isCLickOurService ? 'image2_1109_3' : 'no-data'}
          key={'no_image2_1109_3'}
          width="355"
          style={{ opacity: isCLickOurService ? 0 : 1 }}
          href={images.home.btnOurService}
        />
        <image
          id={'image2_1109_3'}
          width="355"
          key={`${isCLickOurService}`}
          href={images.home.btnOurServiceClick}
        />
