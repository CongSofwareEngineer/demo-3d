export const images = {
  loadingFirstPage: '/assets/gif/loadingFirstPage.gif',
  comingSoon: {
  ...
  home: {
    btnContact: '/assets/images/Home/btnContact.webp',
    btnContactClick: '/assets/images/Home/btnContactClick.webp',
    btnAboutUs: '/assets/images/Home/btnAboutUs.webp',
    btnAboutUsClick: '/assets/images/Home/btnAboutUsClick.webp',
    btnOurService: '/assets/images/Home/btnOurService.webp',
    btnOurServiceClick: '/assets/images/Home/btnOurServiceClick.webp',
    btnPortFlto: '/assets/images/Home/btnPortFlto.webp',
    btnPortFltoClick: '/assets/images/Home/btnPortFltoClick.webp',
    btnTree: '/assets/images/Home/btnTree.webp',
    btnTreeClick: '/assets/images/Home/btnTreeClick.webp',
